...
public class RegisterListPageController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try{
            ...
            Parent contentArea = FXMLLoader.load(getClass().getResource("/com/example/ayeyarricemill/PadBuyList.fxml"));
